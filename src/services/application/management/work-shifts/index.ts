...
import type {
  ...
  GetWorkshiftsParams,
  CreateLocationWorkshiftInput,
  GetLocationWorkshiftsParams,
  CreateUserWorkshiftInput,
...
export const httpRequestCreateWorkshift = async (
...
export const httpRequestUpdateWorkshift = async (
  id: number,
...
export const httpRequestCreateLocationWorkshift = async (
  input: CreateLocationWorkshiftInput,
  ...
  try {
    ...
    if (error) throw error;
    return data as ILocationWorkshift;
  } catch (error) {
    console.error("Error creating location workshift:", error);
    throw error;
  }
};
...
export const httpRequestCreateUserWorkshift = async (
  input: CreateUserWorkshiftInput,
  ...
  try {
    ...
    if (error) throw error;
    return data as IUserWorkshift;
  } catch (error) {
    console.error("Error creating user workshift:", error);
    throw error;
  }
};
