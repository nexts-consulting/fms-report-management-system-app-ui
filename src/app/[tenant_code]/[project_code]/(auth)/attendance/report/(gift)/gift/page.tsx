...
import { GiftCheckPhoneScreen } from "@/components/refine/screens/gift-check-phone.screen";
import { GiftGamesScreen } from "@/components/refine/screens/gift-games.screen";
import { GiftLuckyWheelScreen } from "@/components/refine/screens/gift-lucky-wheel.screen";
  ...
  return (
    <>
      ...
      <div className="flex h-full flex-col">
        ...
        {currentSurveyStep === "gift-check-phone" && <GiftCheckPhoneScreen />}
        {currentSurveyStep === "gift-games" && <GiftGamesScreen />}
        {currentSurveyStep === "gift-lucky-wheel" && <GiftLuckyWheelScreen />}
        ...
        {currentSurveyStep === "complete" && <CompleteScreen screenType="gift" />}
      </div>
      <Footer />
    </>
  );
